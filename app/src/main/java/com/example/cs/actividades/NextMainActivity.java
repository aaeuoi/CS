...
import com.example.cs.fragmentos.MainTextosDetailFragment;
...
// BaseActivity
        ...
        //initialize();
// Fin BaseActivity
        String des = MainActivity.arrayDescripcion;
        String obj = MainActivity.arrayObjetivos;
        String con = MainActivity.arrayContenidos;
        String pos = String.valueOf(MainActivity.arrayPosicionReal + 1);
        String fin = String.valueOf(MainActivity.arrayPosicionFin + 1);
        String sku = MainActivity.arraySku;
        String nom = MainActivity.arrayNombre;
        textos[0] = des;
        textos[1] = obj;
        textos[2] = con;
        ...
        pagerAdapter.agregarFragmentos(MainTextosDetailFragment.newInstance(nom, pos, "_de_",fin, "DESCRIPCION -> Objetivos -> Contenidos",textos[0]));
        pagerAdapter.agregarFragmentos(MainTextosDetailFragment.newInstance(nom, pos, "_de_",fin, "Descripción <- OBJETIVOS -> Contenidos",textos[1]));
        pagerAdapter.agregarFragmentos(MainTextosDetailFragment.newInstance(nom, pos, "_de_",fin, "Descripción <- Objetivos <- CONTENIDOS",textos[2]));
...
/*
    ...
    protected int getLayout() {
        return R.layout.activity_main_next;
    }
    /*protected int getLayout() {
