...
import com.example.cs.fragmentos.ConsultoriaDetailFragment;
import com.example.cs.fragmentos.ConvocatoriaDetailFragment;
...
*/
            ...
            mViewPager = findViewById(R.id.pagerconsultoria);
            adapterCursos.agregarFragmentos(ConsultoriaDetailFragment.newInstance(v00[0], v01[0], v02[0],
                    v03[0], v04[0], v05[0], v06[0], v07[0], v08[0], v09[0], v10[0], v11[0], v12[0], v13[0],
                    v14[0], v15[0], v16[0], v17[0], v18[0], v19[0], v20[0]));
            adapterCursos.agregarFragmentos(ConsultoriaDetailFragment.newInstance(v00[1], v01[1], v02[1],
                    v03[1], v04[1], v05[1], v06[1], v07[1], v08[1], v09[1], v10[1], v11[1], v12[1], v13[1],
                    v14[1], v15[1], v16[1], v17[1], v18[1], v19[1], v20[1]));
            adapterCursos.agregarFragmentos(ConsultoriaDetailFragment.newInstance(v00[2], v01[2], v02[2],
